...
// dispatchCustomEvent(eventName) is used by blocks (e.g. create-account) to fire
// tracking events once Launch/Satellite is ready, queueing them until it is.
// ==========================================
...
function flushQueuedLaunchEvents() {
